...
contract Voting is Ownable {
    ...
    function getOneProposal(uint _id) external view returns (string memory) {
    ...
    function RegisteringVoters() external onlyOwner {
        require(workflowStatus == WorkflowStatus.VotesTallied, 'Registering voters cant be started now');
   ...
   function tallyVotes() external onlyOwner {
    ...
    function restartSession() external onlyOwner{
        require(workflowStatus == WorkflowStatus.VotesTallied, "Counting votes not finished yet"); 
